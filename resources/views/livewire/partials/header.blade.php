<header class="header header--loggedIn">
    <div class="container">
        <a href="{{ route('home') }}" wire:navigate class="header__logo">
        ...
        <nav class="header__menu" x-data="{ open: false }" @click.away="open = false">
            @if (auth()->check())
                ...
                <div class="header__user">
                    <a href="#">
                        <div class="avatar avatar--medium active">
                            <img
                                src="{{ auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('assets/avatar.svg') }}" />
                        </div>
                        <p>{{ auth()->user()->name }}</p>
                    </a>
                ...
                <div class="dropdown-menu show" style="display: none;" x-show="open">
                    <a href="#" class="dropdown-link"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <a href="#" class="dropdown-link"
                            onclick="event.preventDefault(); this.closest('form').submit();"><svg version="1.1"
